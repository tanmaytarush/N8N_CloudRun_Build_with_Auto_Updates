...
deploy() {
    ...
    gcloud builds submit \
      ...
      --substitutions=_PROJECT_ID=$PROJECT_ID,_REGION=$REGION,_SERVICE_NAME=$SERVICE_NAME,_N8N_HOST=$N8N_HOST,_N8N_PORT=$N8N_PORT,_N8N_PROTOCOL=$N8N_PROTOCOL,_N8N_BASIC_AUTH_ACTIVE=$N8N_BASIC_AUTH_ACTIVE,_N8N_BASIC_AUTH_USER=$N8N_BASIC_AUTH_USER,_N8N_BASIC_AUTH_PASSWORD="$N8N_BASIC_AUTH_PASSWORD",_DB_TYPE=$DB_TYPE,_DB_SQLITE_POOL_SIZE=$DB_SQLITE_POOL_SIZE,_N8N_ENCRYPTION_KEY=$N8N_ENCRYPTION_KEY,_N8N_RUNNERS_ENABLED=$N8N_RUNNERS_ENABLED,_N8N_BLOCK_ENV_ACCESS_IN_NODE=$N8N_BLOCK_ENV_ACCESS_IN_NODE,_N8N_ENFORCE_SETTINGS_FILE_PERMISSIONS=$N8N_ENFORCE_SETTINGS_FILE_PERMISSIONS,_GENERIC_TIMEZONE=$GENERIC_TIMEZONE,_TZ=$TZ,_N8N_EDITOR_BASE_URL=$N8N_EDITOR_BASE_URL,_N8N_WEBHOOK_URL=$N8N_WEBHOOK_URL,_N8N_HOME=$N8N_HOME \
      --project $PROJECT_ID
